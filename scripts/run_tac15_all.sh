#!/usr/bin/env bash
#
# Run TAC15 evaluation and analysis
set -e

usage="Usage: $0 GOLD SYSTEMS_DIR OUT_DIR [-x EXCLUDED_SPANS]"
...
# CALCULATE SCORES
$SCR/run_tac15_evaluation.sh $gold $sysdir $outdir $JOBS $@
