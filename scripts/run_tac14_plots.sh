...
./nel plot-systems "$LABELMAP" --heatmap --by-measure -o $plotdir/heatmap/all.pdf --sort-by=name --figsize=$syscols_figsize $ALL_MEASURES $evaldir/*.evaluation
./nel plot-systems "$LABELMAP" --heatmap --by-measure -o $plotdir/heatmap/tac14.pdf --sort-by=name -m tac14 --figsize=$syscols_figsize $evaldir/*.evaluation
./nel plot-systems "$LABELMAP" --heatmap --by-measure -o $plotdir/heatmap/tac14-official.pdf --sort-by=name --figsize=$syscols_figsize -m strong_mention_match -m strong_typed_mention_match -m strong_all_match -m mention_ceaf $evaldir/*.evaluation
